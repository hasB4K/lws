...
| `disaggregatedset.x-k8s.io/intended-replicas`             | Replica target the DisaggregatedSet revision is intended to reach.     | 2                                | LeaderWorkerSet                                                                         |
| `disaggregatedset.x-k8s.io/initial-replicas`              | Deprecated legacy key, read for compatibility during controller upgrades. | 2                             | LeaderWorkerSet                                                                         |
